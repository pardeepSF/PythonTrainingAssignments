...
class TestCalculations(unittest.TestCase):
    ...
    def test_sum(self):
        ...
        self.assertNotEqual(self.calculation.get_sum(), 5, 'The sum is wrong.')

    def test_diff(self):
        self.assertEqual(self.calculation.get_difference(), 6, 'The difference is wrong.')
        self.assertNotEqual(self.calculation.get_difference(), 2, 'The difference is wrong.')

    def test_product(self):
        self.assertEqual(self.calculation.get_product(), 16, 'The product is wrong.')
        self.assertNotEqual(self.calculation.get_product(), 10, 'The product is wrong.')

    def test_quotient(self):
        self.assertEqual(self.calculation.get_quotient(), 4, 'The quotient is wrong.')
        self.assertNotEqual(self.calculation.get_quotient(), 3, 'The division is wrong.')
